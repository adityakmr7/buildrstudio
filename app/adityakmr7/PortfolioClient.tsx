  ...
  return (
    <div className="ab">
      <style>{`
        ...
        .ab-section-label { font-size: 11px; font-weight: 700; letter-spacing: 0.12em; text-transform: uppercase; color: var(--text-3); margin-bottom: 20px; font-family: monospace; }
        ...
        .ab-skill-item { display: flex; justify-content: space-between; align-items: center; padding: 5px 0; font-size: 13px; color: var(--text-2); }
        .ab-skill-num { font-family: monospace; font-size: 12px; color: var(--fill); font-weight: 700; }
        .ab-ach-list { display: grid; grid-template-columns: 1fr 1fr; gap: 1px; background: var(--border); border: 1px solid var(--border); }
        .ab-ach-row { display: flex; flex-direction: column; gap: 4px; padding: 16px 20px; background: var(--bg); transition: background 0.12s; }
        .ab-ach-row:hover { background: var(--surface); }
        .ab-ach-title { font-size: 13px; color: var(--text-2); font-weight: 500; line-height: 1.4; }
        .ab-ach-meta { font-size: 10px; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; font-family: monospace; color: var(--fill); }
        ...
        @media (max-width: 640px) {
          ...
          .ab-ach-list { grid-template-columns: 1fr; }
      ...
      <div className="ab-inner">
        ...
        <section className="ab-section">
          <div className="ab-section-label">Stack Depth</div>
        ...
        <section className="ab-section">
          <div className="ab-section-label">Proof, Not Adjectives</div>
        ...
        <section className="ab-section">
          <div className="ab-section-label">What I&apos;ve Shipped</div>
          <div>
            {PROJECTS.map((p) => (
        ...
        <section className="ab-section">
          <div className="ab-section-label">Career Timeline</div>
